...
@section('content_header')
    <h1><b>Modificar Presentacion</b></h1>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $presentacione->caracteristica->nombre }}" name="nombre" required>
                                    @error('nombre')
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $presentacione->caracteristica->descripcion }}" name="descripcion">
                                    @error('descripcion')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
